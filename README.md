...
**Current version:** 6.27 — helper recordings and Music only exports are **OGG** (not MP4/MP3). See badge in `twitch-auto-recorder.html` / `HELPER_VERSION` in `twitch-recorder-server.py` (also `VERSION`).
